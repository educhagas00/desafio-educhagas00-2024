class RecintosZoo {
    ...
    analisaRecintos(animal, quantidade) {
        ...
        const espacoNecessario = listaAnimal.tamanho * quantidade; // espaço que animal ocupa
        ...
        this.recintos.forEach(recinto => {
            ...
            let espacoSuficiente = espacoDisponivel >= espacoNecessario; // se da pra encaixar animal ou nao

            if((recinto.animais.length > 0) && (recinto.animais.some(a => a.especie !== animal)))
            {
                espacoSuficiente = espacoDisponivel >= espacoNecessario + 1;
            }
